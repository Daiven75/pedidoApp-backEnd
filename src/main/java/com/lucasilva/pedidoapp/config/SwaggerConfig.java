...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.lucasilva.pedidoapp.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API pedido-app",
				"",
				"Versão 1.0",
				"",
				new Contact("Lucas Silva", 
						"https://github.com/Daiven75/pedidoApp-backEnd", 
	...
	private ResponseMessage customMessage201() {
		...
		headers.put("location", new Header("location", "URI novo recurso criado", new ModelRef("string")));
